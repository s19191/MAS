...
public class Electric extends Vehicle {
    ...
    public Electric(String model, String mark, Double wage, Integer howManySeats, Double displacement, BodyOfWater bodyOfWater, int batteryCapacity, double averagePowerConsumption, LocalTime averageChargingTime) {
    ...
    public Electric(String model, String mark, Double wage, Integer howManySeats, Integer howManyWheels, int batteryCapacity, double averagePowerConsumption, LocalTime averageChargingTime) {
