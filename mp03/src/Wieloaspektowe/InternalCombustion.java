...
public class InternalCombustion extends Vehicle {
    ...
    public InternalCombustion(String model, String mark, Double wage, Integer howManySeats, Double displacement, BodyOfWater bodyOfWater, double tankCapacity, double averageCombustion, TypeOfGearbox typeOfGearbox) {
        super(model, mark, wage, howManySeats, displacement, bodyOfWater);
        this.tankCapacity = tankCapacity;
        this.averageCombustion = averageCombustion;
        this.typeOfGearbox = typeOfGearbox;
    }

    public InternalCombustion(String model, String mark, Double wage, Integer howManySeats, Integer howManyWheels, double tankCapacity, double averageCombustion, TypeOfGearbox typeOfGearbox) {
        super(model, mark, wage, howManySeats, howManyWheels);
        this.tankCapacity = tankCapacity;
        this.averageCombustion = averageCombustion;
        this.typeOfGearbox = typeOfGearbox;
    }
